...
const responseMessage = await (
    `*🤖 Aquí tienes la lista de algunos sub bots  🤖️* \n\n
    *👉🏻 Puedes contactarlos para ver si se unen a tu grupo*\ n\n
...
await _envio.sendMessage(m.chat, {
    text: responseMessage,
     contextInfo: { mentionedJid: _envio.parseMention(responseMessage)}
    }, { quoted: m });
}
